...
const createCow = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    if (!(yield (0, cow_utils_1.isSeller)(payload.seller))) {
...
const updateCow = (_id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    if (!(yield (0, cow_utils_1.isCowFound)(_id))) {
        throw new APIError_1.APIError(400, "Cow not Found!");
    }
    if (payload.seller && !(yield (0, cow_utils_1.isSeller)(payload.seller))) {
        throw new APIError_1.APIError(http_status_1.default.BAD_REQUEST, "Seller account is incorrect!");
    }
